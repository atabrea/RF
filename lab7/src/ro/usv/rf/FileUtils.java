...
public class FileUtils 
{
	...
	public static double[][] readLearningSetFromFile(String fileName) throws USVInputFileCustomException
	{
	...
	public static void writeLearningSetToFile(String fileName, double[][] normalizedSet)
	{
